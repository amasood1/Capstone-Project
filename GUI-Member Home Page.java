...
public class Member {
	...
	private void initialize() {
		...
		frmCrossconnect.getContentPane().setBackground(new Color(204, 204, 204));
		...
		btnAdd.setBounds(228, 465, 89, 23);
		frmCrossconnect.getContentPane().add(btnAdd);
		
		JButton btnUpdate = new JButton("UPDATE");
		btnUpdate.setBounds(382, 465, 89, 23);
		frmCrossconnect.getContentPane().add(btnUpdate);
		
		JButton btnDelete = new JButton("DELETE");
		btnDelete.setBounds(543, 465, 89, 23);
		frmCrossconnect.getContentPane().add(btnDelete);
		
		JButton btnExit = new JButton("EXIT");
		btnExit.setBounds(382, 514, 89, 23);
		frmCrossconnect.getContentPane().add(btnExit);
