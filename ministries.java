...
public class ministries {
	...
	private void initialize() {
		...
		frmCrossconnect4.getContentPane().setBackground(new Color(204, 204, 204));
		...
		lblSelectAYear.setBounds(234, 101, 213, 14);
		...
		choice.setBounds(451, 95, 131, 20);
		frmCrossconnect4.getContentPane().add(choice);
		
		JTextArea textArea = new JTextArea();
		textArea.setBounds(234, 137, 348, 219);
